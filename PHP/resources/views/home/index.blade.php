...
@section ('content')
    ...
    <div style= "text-align: center;">
        <a href="/movies/{{ $bp->id }}"><img src="{{ URL::asset('photos/black-panther.jpg') }}" style="text-align: center; width: 100%;"></a>
    </div>
    ...
    <div class="w3-container w3-padding-32 " style="margin-left: 150px; margin-right: 150px;">
        <b><font size="5">NEW RELEASE DVD & Blue-ray  </font> <b><a href="/movies" >see all></a>
    </div>
